...
class LastRowMakeBedScreen extends StatefulWidget {
  const LastRowMakeBedScreen({Key? key}) : super(key: key);

  @override
  State<LastRowMakeBedScreen> createState() => _LastRowMakeBedScreenState();
}

class _LastRowMakeBedScreenState extends State<LastRowMakeBedScreen> {
  @override
