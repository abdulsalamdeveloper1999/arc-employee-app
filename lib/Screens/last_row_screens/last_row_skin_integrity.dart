...
class LastRowSkinIntegrity extends StatefulWidget {
  const LastRowSkinIntegrity({Key? key}) : super(key: key);

  @override
  State<LastRowSkinIntegrity> createState() => _LastRowSkinIntegrityState();
}

class _LastRowSkinIntegrityState extends State<LastRowSkinIntegrity> {
  @override
