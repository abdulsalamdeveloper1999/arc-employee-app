...
class LastRowAdcalScreen extends StatefulWidget {
  const LastRowAdcalScreen({Key? key}) : super(key: key);

  @override
  State<LastRowAdcalScreen> createState() => _LastRowAdcalScreenState();
}

class _LastRowAdcalScreenState extends State<LastRowAdcalScreen> {
  @override
