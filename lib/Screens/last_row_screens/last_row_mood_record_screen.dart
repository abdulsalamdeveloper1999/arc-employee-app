...
class LastRowMoodRecordScreen extends StatefulWidget {
  const LastRowMoodRecordScreen({Key? key}) : super(key: key);

  @override
  State<LastRowMoodRecordScreen> createState() =>
      _LastRowMoodRecordScreenState();
}

class _LastRowMoodRecordScreenState extends State<LastRowMoodRecordScreen> {
  @override
