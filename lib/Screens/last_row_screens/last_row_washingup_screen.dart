...
class LastRowWashingUpScreen extends StatefulWidget {
  LastRowWashingUpScreen({Key? key}) : super(key: key);

  @override
  State<LastRowWashingUpScreen> createState() => _LastRowWashingUpScreenState();
}

class _LastRowWashingUpScreenState extends State<LastRowWashingUpScreen> {
  @override
