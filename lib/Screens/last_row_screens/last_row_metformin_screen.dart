...
class LastRowMetforminScreen extends StatefulWidget {
  const LastRowMetforminScreen({Key? key}) : super(key: key);

  @override
  State<LastRowMetforminScreen> createState() => _LastRowMetforminScreenState();
}

class _LastRowMetforminScreenState extends State<LastRowMetforminScreen> {
  @override
