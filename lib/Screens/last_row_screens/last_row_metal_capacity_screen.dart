...
class LastRowMentalCapacityScreen extends StatefulWidget {
  const LastRowMentalCapacityScreen({Key? key}) : super(key: key);

  @override
  State<LastRowMentalCapacityScreen> createState() =>
      _LastRowMentalCapacityScreenState();
}

class _LastRowMentalCapacityScreenState
    extends State<LastRowMentalCapacityScreen> {
  @override
