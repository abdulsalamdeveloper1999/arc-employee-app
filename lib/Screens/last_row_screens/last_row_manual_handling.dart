...
class LastRowManualHandlingScreen extends StatefulWidget {
  const LastRowManualHandlingScreen({Key? key}) : super(key: key);

  @override
  State<LastRowManualHandlingScreen> createState() =>
      _LastRowManualHandlingScreenState();
}

class _LastRowManualHandlingScreenState
    extends State<LastRowManualHandlingScreen> {
  @override
