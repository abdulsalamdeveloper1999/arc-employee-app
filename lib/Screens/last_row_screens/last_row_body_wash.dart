...
class LastRowBodyWashScreen extends StatefulWidget {
  const LastRowBodyWashScreen({Key? key}) : super(key: key);

  @override
  State<LastRowBodyWashScreen> createState() => _LastRowBodyWashScreenState();
}

class _LastRowBodyWashScreenState extends State<LastRowBodyWashScreen> {
  @override
