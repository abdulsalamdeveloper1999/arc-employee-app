import 'package:arcemployee/Screens/last_row_screens/last_row_metformin_screen.dart';
...
class MetforminScreenTwo extends StatefulWidget {
  const MetforminScreenTwo({Key? key}) : super(key: key);

  @override
  State<MetforminScreenTwo> createState() => _MetforminScreenTwoState();
}

class _MetforminScreenTwoState extends State<MetforminScreenTwo> {
  @override
