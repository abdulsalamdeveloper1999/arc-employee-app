import 'package:arcemployee/Screens/last_row_screens/last_row_make_bed_screen.dart';
...
class MakeBedScreenTwo extends StatefulWidget {
  const MakeBedScreenTwo({Key? key}) : super(key: key);

  @override
  State<MakeBedScreenTwo> createState() => _MakeBedScreenTwoState();
}

class _MakeBedScreenTwoState extends State<MakeBedScreenTwo> {
  @override
