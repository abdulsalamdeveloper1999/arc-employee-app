import 'package:arcemployee/Screens/last_row_screens/last_row_hot_mean_screen.dart';
...
class HotMealTwo extends StatefulWidget {
  const HotMealTwo({Key? key}) : super(key: key);

  @override
  State<HotMealTwo> createState() => _HotMealTwoState();
}

class _HotMealTwoState extends State<HotMealTwo> {
  @override
