...
class ColdMealStartScreen extends StatefulWidget {
  const ColdMealStartScreen({Key? key}) : super(key: key);

  @override
  State<ColdMealStartScreen> createState() => _ColdMealStartScreenState();
}

class _ColdMealStartScreenState extends State<ColdMealStartScreen> {
  @override
