...
class DocustateStartScreen extends StatefulWidget {
  const DocustateStartScreen({Key? key}) : super(key: key);

  @override
  State<DocustateStartScreen> createState() => _DocustateStartScreenState();
}

class _DocustateStartScreenState extends State<DocustateStartScreen> {
  @override
