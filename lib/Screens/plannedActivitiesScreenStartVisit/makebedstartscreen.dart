...
class MakeBedStartScreen extends StatefulWidget {
  const MakeBedStartScreen({Key? key}) : super(key: key);

  @override
  State<MakeBedStartScreen> createState() => _MakeBedStartScreenState();
}

class _MakeBedStartScreenState extends State<MakeBedStartScreen> {
  @override
