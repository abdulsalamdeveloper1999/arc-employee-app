...
class AdcalStartingScreen extends StatefulWidget {
  const AdcalStartingScreen({Key? key}) : super(key: key);

  @override
  State<AdcalStartingScreen> createState() => _AdcalStartingScreenState();
}

class _AdcalStartingScreenState extends State<AdcalStartingScreen> {
  @override
