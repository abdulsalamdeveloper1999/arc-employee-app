...
class BodyWashStartScreen extends StatefulWidget {
  const BodyWashStartScreen({Key? key}) : super(key: key);

  @override
  State<BodyWashStartScreen> createState() => _BodyWashStartScreenState();
}

class _BodyWashStartScreenState extends State<BodyWashStartScreen> {
  @override
