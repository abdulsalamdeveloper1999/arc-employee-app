import 'package:arcemployee/Screens/adcal_d3_screen_two.dart';
...
class AdcalScreen extends StatefulWidget {
  const AdcalScreen({Key? key}) : super(key: key);

  @override
  State<AdcalScreen> createState() => _AdcalScreenState();
}

class _AdcalScreenState extends State<AdcalScreen> {
  @override
