import 'package:arcemployee/Screens/docusate_two_screen.dart';
...
class DocusateScreen extends StatefulWidget {
  const DocusateScreen({Key? key}) : super(key: key);

  @override
  State<DocusateScreen> createState() => _DocusateScreenState();
}

class _DocusateScreenState extends State<DocusateScreen> {
  @override
