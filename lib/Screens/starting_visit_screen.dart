...
List namingTextStartingVisitScreen = [
  'Manual Handling',
  'Body Wash',
  'Skin Integrity',
  'Apply moisture',
...
class StartingVisitScreen extends StatefulWidget {
  const StartingVisitScreen({Key? key}) : super(key: key);

  @override
  State<StartingVisitScreen> createState() => _StartingVisitScreenState();
}

class _StartingVisitScreenState extends State<StartingVisitScreen> {
  @override
  void initState() {
