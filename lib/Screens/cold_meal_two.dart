import 'package:arcemployee/Screens/last_row_screens/last_row_cold_meal_screen.dart';
...
class ColdMealTwo extends StatefulWidget {
  const ColdMealTwo({Key? key}) : super(key: key);

  @override
  State<ColdMealTwo> createState() => _ColdMealTwoState();
}

class _ColdMealTwoState extends State<ColdMealTwo> {
  @override
