...
class DocusateScreenTwo extends StatefulWidget {
  const DocusateScreenTwo({Key? key}) : super(key: key);

  @override
  State<DocusateScreenTwo> createState() => _DocusateScreenTwoState();
}

class _DocusateScreenTwoState extends State<DocusateScreenTwo> {
  @override
