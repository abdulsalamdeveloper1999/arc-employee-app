import 'package:arcemployee/Screens/last_row_screens/last_row_body_wash.dart';
...
class BodyWashScreenTwo extends StatefulWidget {
  const BodyWashScreenTwo({Key? key}) : super(key: key);

  @override
  State<BodyWashScreenTwo> createState() => _BodyWashScreenTwoState();
}

class _BodyWashScreenTwoState extends State<BodyWashScreenTwo> {
  @override
